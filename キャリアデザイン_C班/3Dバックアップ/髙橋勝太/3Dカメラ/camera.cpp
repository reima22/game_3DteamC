...
void UpdateCamera(void)
{
	...
	{
		g_camera.Camera -= 0.1f;
		g_camera.posV.x = g_camera.posR.x - sinf(D3DX_PI + g_camera.Camera) * 100;
		g_camera.posV.z = g_camera.posR.z + cosf(D3DX_PI + g_camera.Camera) * 100;
	}
	...
	if (GetKeyboardPress(DIK_SPACE) == true)
	{
		...
		pModel->pos = D3DXVECTOR3(0.0f, 15.0f, 0.0f);
	}
}
