...
HRESULT Init(HINSTANCE hInstance, HWND hWnd, BOOL bWindow)
{
	...
	//SetEffect(D3DXVECTOR3(20.0f, 10.0f, 0.0f),D3DXVECTOR3(0.0f, 0.0f, 0.0f),5000);

	//SetEffect(D3DXVECTOR3(40.0f, 10.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), 5000);
	...
	//	fAngle = (float)(rand() % 100) / 100.0f;
	//	move.x = sinf(fAngle)*0.3f;
	//	move.y = cosf(fAngle)*0.3f;
	//	move.z = sinf(fAngle)*0.1f;
	//	SetEffect(D3DXVECTOR3(20.0f, 10.0f, 0.0f), move, 500);
	//}
...
void Update(void)
{
	...
	//	//fAngle = (float)(rand()% 628 - 314) / 100.0f;
	//	fAngle = (float)(rand() % 100) / 100.0f;
	//	move.x = sinf(fAngle)*0.5f;
	//	move.y = rand() % 4 - 2;
	//	move.z = cosf(fAngle)*0.1f;
	//	SetEffect(D3DXVECTOR3(20.0f, 2.0f, 15.0f), move, 100);
	//}
...
void DrawFPS(void)
{
	...
	//nNum += sprintf(&aStr[nNum], "effect.pos.x:%.2f\n", pEffect->pos.x);
	//nNum += sprintf(&aStr[nNum], "effect.pos.y:%.2f\n", pEffect->pos.y);
	//nNum += sprintf(&aStr[nNum], "effect.pos.z:%.2f\n", pEffect->pos.z);
