...
#define TUTORIAL_BG_SIZE_X (600)			//タイトル画面の横幅
#define TUTORIAL_BG_SIZE_Y (280)			//タイトル画面の立幅
#define TUTORIAL_SIZE_X (500)				//チュートリアル横幅
#define TUTORIAL_SIZE_Y (75)				//チュートリアル立幅
#define TUTORIAL_ENTER_SIZE_X (100)			//プレスエンターの横幅
#define TUTORIAL_ENTER_SIZE_Y (30)			//プレスエンターの立幅
#define TUTORIAL_BG_POS_X (640)				//背景の場所X
#define TUTORIAL_BG_POS_Y (420)				//背景の場所Y
#define TUTORIAL_POS_X (860)				//チュートリアルの場所X
#define TUTORIAL_POS_Y (75)					//チュートリアルの場所Y
#define PRESSENTER_POS_X (1150)				//プレスエンターの場所X
#define PRESSENTER_POS_Y (660)				//プレスエンターの場所Y
...
HRESULT InitTutorial(void)
{
	...
	//テクスチャ読み込み
	D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/tutorial.jpg", &g_pTextureTutorial[0]);
